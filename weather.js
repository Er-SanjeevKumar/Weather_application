//  const downloadCsv = async () => {
    ...
    const downloadCsv = async () => {
       const url2 =
        ...
        //const url2 = `https://weatherapi-com.p.rapidapi.com/current.json?q={val}`;
        const options = {
            method: 'GET',
            headers: {
                'X-RapidAPI-Key': 'fda95444dfmshcf13e5a5c746d68p1cc562jsnb32430732f85',
                'X-RapidAPI-Host': 'weatherapi-com.p.rapidapi.com'
            }
        };
      ...
      try {
        ...
        document.getElementById("id11").innerText = data.current.temp_c;
